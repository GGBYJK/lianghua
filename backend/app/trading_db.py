...
backtest_runs = Table(
    ...
    Column("completed_combinations", Integer, nullable=False, server_default="0"),
...
backtest_series = Table(
    ...
    Column("payload_blob", LargeBinary(length=4294967295), nullable=False),
    Column("created_at", DateTime, nullable=False, server_default=func.now()),
    UniqueConstraint("run_id", "symbol", "timeframe", name="uq_backtest_series_run_symbol_timeframe"),
    Index("idx_backtest_series_run", "run_id"),
)

backtest_rule_summaries = Table(
    ...
    Column("breakevens", Integer, nullable=False, server_default="0"),
    Column("incomplete", Integer, nullable=False, server_default="0"),
    Column("take_profit_hits", Integer, nullable=False, server_default="0"),
    Column("stop_hits", Integer, nullable=False, server_default="0"),
    Column("time_exits", Integer, nullable=False, server_default="0"),
    Column("win_rate", Numeric(12, 6), nullable=False, server_default="0"),
    Column("gross_pnl", money_type, nullable=True),
    Column("net_pnl", money_type, nullable=True),
    Column("avg_r", Numeric(16, 8), nullable=False, server_default="0"),
...
backtest_orders = Table(
    ...
    Column("id", String(36), primary_key=True),
    Column("run_id", String(36), ForeignKey("backtest_runs.id", ondelete="CASCADE"), nullable=False),
    Column("series_id", String(36), ForeignKey("backtest_series.id", ondelete="CASCADE"), nullable=False),
    Column("rule_key", String(80), nullable=False),
    Column("rule_label", String(120), nullable=False),
    Column("signal_key", String(160), nullable=False),
    Column("symbol", String(40), nullable=False),
    Column("timeframe", String(16), nullable=False),
    ...
    Column("entry_price", money_type, nullable=True),
    Column("partial_exit_time", DateTime, nullable=True),
    Column("partial_exit_price", money_type, nullable=True),
    Column("partial_exit_quantity", Integer, nullable=False, server_default="0"),
    Column("partial_net_pnl", money_type, nullable=True),
    Column("stop_price", money_type, nullable=True),
    Column("target_price", money_type, nullable=True),
    Column("exit_price", money_type, nullable=True),
    Column("gross_pnl", money_type, nullable=True),
    Column("net_pnl", money_type, nullable=True),
    Column("fees", money_type, nullable=True),
    Column("slippage", money_type, nullable=True),
    Column("r_multiple", Numeric(16, 8), nullable=True),
    Column("holding_bars", Integer, nullable=False, server_default="0"),
    Column("mfe_r", Numeric(16, 8), nullable=True),
    Column("mae_r", Numeric(16, 8), nullable=True),
    Column("cost_available", Boolean, nullable=False, server_default="0"),
