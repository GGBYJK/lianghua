...
function ContractsPage() {
  ...
  const importMutation = useMutation({
    ...
    onSuccess: (result) => {
      api.success(`已导入 ${result.imported} 个品种参数`);
